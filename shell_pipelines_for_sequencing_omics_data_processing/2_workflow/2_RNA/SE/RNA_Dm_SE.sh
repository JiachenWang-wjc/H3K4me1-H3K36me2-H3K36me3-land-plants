...
do
	echo "${id}"
	/home/wangjiachen/anaconda3/envs/hisat2/bin/hisat2 -p 40 -x /media/wangjiachen/disk5/XWH/genome/Ensembl/D_melanogaster/hisat2_index/hisat2_index -U ${id}.fq.gz -S ${id}.sam
	echo "map done"
