...
do
	echo "${id}"
	/home/wangjiachen/anaconda3/envs/hisat2/bin/hisat2 -p 40 -x /media/wangjiachen/disk1/genome/sc/hisat2/hisat2_index_sc -U ${id}.fq.gz -S ${id}.sam
	echo "map done"
	...
	echo "sort done"
	/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools rmdup -s ${id}_rmMt_q20_s.bam ${id}_rmMt_q20_s_rmdup.bam
	echo "rmdup done"
	/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools index -@ 40 ${id}_rmMt_q20_s_rmdup.bam
	echo "index done"
	...
	/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}_rmMt_q20_s_rmdup.bam
	echo "sam_count"
	echo "rmMt_count"
	echo "q20_count"
	echo "rmdup_count"
