...
do
echo "${id}"
/home/wangjiachen/anaconda3/envs/hisat2/bin/hisat2 -p 40 --dta --rna-strandness RF -x /media/wangjiachen/disk1/genome/sc/hisat2/hisat2_index_sc -1 ${id}_R1.fq.gz -2 ${id}_R2.fq.gz -S ${id}.sam
echo "map done"
