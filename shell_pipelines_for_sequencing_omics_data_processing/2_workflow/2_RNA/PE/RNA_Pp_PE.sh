...
do
echo "${id}"
/home/wangjiachen/anaconda3/envs/hisat2/bin/hisat2 -p 40 --dta --rna-strandness RF -x /media/wangjiachen/disk1/genome/Pp/hisat2_Pp_tx/hisat2_index_Pp -1 ${id}_R1.fq.gz -2 ${id}_R2.fq.gz -S ${id}.sam
echo "map done"
...
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -@ 40 -q 20 -bS ${id}_rmscaffold.sam > ${id}_rmscaffold_q20.bam
echo "q20 bam done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools sort -@ 40 -n ${id}_rmscaffold_q20.bam -o ${id}_rmscaffold_q20_s1.bam
echo "nsort1 done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools fixmate -@ 40 -m ${id}_rmscaffold_q20_s1.bam ${id}_rmscaffold_q20_s1_fixmate.bam
echo "fixmate done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools sort -@ 40 ${id}_rmscaffold_q20_s1_fixmate.bam -o ${id}_rmscaffold_q20_s1_fixmate_s2.bam
echo "sort2 done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools markdup -@ 40 -r ${id}_rmscaffold_q20_s1_fixmate_s2.bam ${id}_rmscaffold_q20_s1_fixmate_s2_markdup.bam
echo "markdup done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools sort -@ 40 ${id}_rmscaffold_q20.bam -o ${id}_rmscaffold_q20_s.bam
echo "sort done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools index -@ 40 ${id}_rmscaffold_q20_s.bam
echo "index done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}.sam
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}_rmscaffold.sam
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}_rmscaffold_q20.bam
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}_rmscaffold_q20_s.bam
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}_rmscaffold_q20_s1_fixmate_s2_markdup.bam
echo "reads count done"
rm ${id}.sam ; rm ${id}_rmscaffold.sam ; rm ${id}_rmscaffold_q20.bam ; rm ${id}_rmscaffold_q20_s1_fixmate_s2_markdup.bam
rm ${id}_rmscaffold_q20_s1.bam ; rm ${id}_rmscaffold_q20_s1_fixmate.bam ; rm ${id}_rmscaffold_q20_s1_fixmate_s2.bam
echo "sam_count"
