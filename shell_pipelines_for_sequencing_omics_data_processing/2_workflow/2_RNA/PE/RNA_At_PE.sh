...
do
echo "${id}"
/home/wangjiachen/anaconda3/envs/hisat2/bin/hisat2 -p 40 --dta --rna-strandness RF -x /media/wangjiachen/disk1/genome/fixed_TAIR10/hisat2_index/hisat2_index -1 ${id}_R1.fq.gz -2 ${id}_R2.fq.gz -S ${id}.sam
echo "map done"
...
echo "q20 bam done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools sort -@ 40 -n ${id}_rmptmt_q20.bam -o ${id}_rmptmt_q20_s1.bam
echo "nsort1 done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools fixmate -@ 40 -m ${id}_rmptmt_q20_s1.bam ${id}_rmptmt_q20_s1_fixmate.bam
echo "fixmate done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools sort -@ 40 ${id}_rmptmt_q20_s1_fixmate.bam -o ${id}_rmptmt_q20_s1_fixmate_s2.bam
echo "sort2 done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools markdup -@ 40 -r ${id}_rmptmt_q20_s1_fixmate_s2.bam ${id}_rmptmt_q20_s1_fixmate_s2_markdup.bam
echo "markdup done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools sort -@ 40 ${id}_rmptmt_q20.bam -o ${id}_rmptmt_q20_s.bam
echo "sort done"
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools index -@ 40 ${id}_rmptmt_q20_s.bam
echo "index done"
...
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}_rmptmt_q20_s.bam
/home/wangjiachen/anaconda3/envs/hisat2/bin/samtools view -F 4 -@ 40 -c ${id}_rmptmt_q20_s1_fixmate_s2_markdup.bam
