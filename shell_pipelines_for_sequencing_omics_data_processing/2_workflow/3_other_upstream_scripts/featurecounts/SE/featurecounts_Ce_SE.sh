...
do
echo "${id}"
featureCounts -T 40  -s 0 -t exon -g gene_id -F GTF -a /media/wangjiachen/disk6/test/scripts/genome/10_Ce/Caenorhabditis_elegans.WBcel235.105.gtf -o ${id}.count ${id}.bam
echo "count done"
