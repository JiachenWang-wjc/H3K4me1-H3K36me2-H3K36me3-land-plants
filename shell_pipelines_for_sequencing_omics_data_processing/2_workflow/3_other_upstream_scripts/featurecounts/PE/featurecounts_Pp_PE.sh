...
do
echo "${id}"
featureCounts -T 40  -p -B -C -s 2 -t exon -g gene_id -F GTF -a /media/wangjiachen/disk6/test/scripts/genome/4_Pp/Physcomitrella_patens.Phypa_V3.48.gtf -o ${id}.count ${id}.bam
echo "count done"
