...
do
echo "${id}"
featureCounts -T 40  -p -B -C -s 2 -t exon -g gene_id -F GTF -a /media/wangjiachen/disk6/test/scripts/genome/9_Dm/Drosophila_melanogaster.BDGP6.32.105.gtf -o ${id}.count ${id}.bam
echo "count done"
