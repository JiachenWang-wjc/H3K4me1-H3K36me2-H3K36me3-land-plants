...
do
echo "${id}"
featureCounts -T 40  -p -B -C -s 2 -t exon -g gene_id -F GTF -a /media/wangjiachen/disk1/genome/sc/from_ens_Saccharomyces_cerevisiae.R64-1-1.57.gtf -o ${id}.count ${id}.bam
echo "count done"
