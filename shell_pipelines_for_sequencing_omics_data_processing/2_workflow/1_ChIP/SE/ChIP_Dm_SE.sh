...
do
echo "${id}"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/bowtie2 -p 10 -x /media/wangjiachen/disk5/XWH/genome/Ensembl/D_melanogaster/bowtie2_index/bowtie2_index -U ${id}.fq.gz -S ${id}.sam
echo "map done"
