...
do
echo "${id}"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/bowtie2 -p 40 -x /media/wangjiachen/disk1/genome/Cr/bowtie2_Cr_lz_index/bowtie2_index -U ${id}.fq.gz -S ${id}.sam
echo "map done"
...
echo "q20 bam done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools sort -@ 40 ${id}_rmKZ4549XX_q20.bam -o ${id}_rmKZ4549XX_q20_s.bam
echo "sort done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools rmdup  -s ${id}_rmKZ4549XX_q20_s.bam ${id}_rmKZ4549XX_q20_s_rmdup.bam
echo "rmdup done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools index -@ 40 ${id}_rmKZ4549XX_q20_s_rmdup.bam
echo "index done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}.sam
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}_rmKZ4549XX.sam
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}_rmKZ4549XX_q20.bam
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}_rmKZ4549XX_q20_s_rmdup.bam
echo "sam_count"
