...
echo "q20 bam done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools sort -@ 40 ${id}_rmCMKZ_q20.bam -o ${id}_rmCMKZ_q20_s.bam
echo "sort done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools rmdup  -s ${id}_rmCMKZ_q20_s.bam ${id}_rmCMKZ_q20_s_rmdup.bam
echo "rmdup done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools index -@ 40 ${id}_rmCMKZ_q20_s_rmdup.bam
echo "index done"
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}.sam
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}_rmCMKZ.sam
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}_rmCMKZ_q20.bam
/home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -F 4 -@ 40 -c ${id}_rmCMKZ_q20_s_rmdup.bam
echo "sam_count"
echo "rmCMKZ_count"
echo "q20_count"
echo "rmdup_count"
echo "reads_count_done"
rm ${id}_rmCMKZ_q20_s.bam ; rm ${id}_rmCMKZ_q20.bam ; rm ${id}_rmCMKZ.sam ; rm ${id}.sam
done
