...
do
   echo "${id}"
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/bowtie2 -p 40 --no-mixed --no-discordant -x /media/wangjiachen/disk1/genome/Pp/bowtie2_Pp_tx/bowtie2_index -1 ${id}_R1.fq.gz -2 ${id}_R2.fq.gz -S ${id}.sam
   echo "map done"
   ...
   echo "q20 bam done"
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools sort -@ 40 -n ${id}_rmscaffold_q20.bam -o ${id}_rmscaffold_q20_s1.bam
   echo "nsort1 done"
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools fixmate -@ 40 -m ${id}_rmscaffold_q20_s1.bam ${id}_rmscaffold_q20_s1_fixmate.bam
   echo "fixmate done"
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools sort -@ 40  ${id}_rmscaffold_q20_s1_fixmate.bam -o ${id}_rmscaffold_q20_s1_fixmate_s2.bam
   echo "sort2 done"
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools markdup -@ 40 -r ${id}_rmscaffold_q20_s1_fixmate_s2.bam ${id}_rmscaffold_q20_s1_fixmate_s2_markdup.bam
   echo "markdup done"
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools index -@ 40 ${id}_rmscaffold_q20_s1_fixmate_s2_markdup.bam
   echo "index done"
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -@ 40 -F 4  -c ${id}.sam
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -@ 40 -F 4  -c ${id}_rmscaffold.sam
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -@ 40 -F 4  -c ${id}_rmscaffold_q20.bam
   /home/wangjiachen/anaconda3/envs/bowtie2/bin/samtools view -@ 40 -F 4  -c ${id}_rmscaffold_q20_s1_fixmate_s2_markdup.bam
   echo "sam_count"
   echo "rmscafflod_count"
   echo "q20_count"
   echo "markdup_count"
   rm ${id}_rmscaffold_q20_s1_fixmate_s2.bam ; rm ${id}_rmscaffold_q20_s1_fixmate.bam ; rm ${id}_rmscaffold_q20_s1.bam ; rm ${id}_rmscaffold_q20.bam ; rm ${id}_rmscaffold.sam ; rm ${id}.sam
   echo "findme"
done
